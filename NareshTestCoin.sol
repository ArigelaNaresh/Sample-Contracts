...
contract NareshTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NareshTestCoin() {
        ...
        name = "NareshTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NTCN";                                             // Set the symbol for display purposes (CHANGE THIS)
